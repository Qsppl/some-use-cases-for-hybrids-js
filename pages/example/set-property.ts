import { ModelIdentifier } from "https://esm.sh/hybrids@8.2.15"

type AllowedValueType<PropertyType> = PropertyType extends { id: ModelIdentifier } ? PropertyType | PropertyType["id"] | undefined : PropertyType
